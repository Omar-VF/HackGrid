...
export const MOCK_WORK_ORDER: WorkOrderTicket = {
  ...
  prescription: {
    chemicalName: "Chlorothalonil 720 SC (Kavach / Bravo)",
    epaRegNumber: "CIBRC / EPA Reg. #50534-188",
    activeIngredient: "Chlorothalonil (54.0% w/w SC)",
    dosagePerAcre: "700 mL / acre (1.75 L / ha)",
    waterVolumePerAcre: "150 L / acre",
    safeToSpray: true,
    windBufferNotice: "Wind speed 10.0 km/h (6.2 mph) < 16 km/h safe limit. Compliant with aquatic buffer zones.",
    totalChemicalVolume: "98.0 Litres (98,000 mL)",
